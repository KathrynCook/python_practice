  ...
  def traverse(self):
    ...
    while story_node.choices != []:
      ...
      if choice not in valid_choices:
        print("Invalid option. Please enter 1 or 2 to continue.")
      else:
...
YOU HAVE ESCAPED THE WILDRENESS.
""")
choice_a_2 = TreeNode("""
The bear returns and tells you that bullying is not okay before leaving you alone in the wildreness.
